# Modeling the Capital Asset Pricing Model (CAPM) for *H-Farm S.p.A.* via Linear Regression

## In order to model CAPM via linear regression, and hence calculate and analyze beta, underlying assumptions must be defined.
